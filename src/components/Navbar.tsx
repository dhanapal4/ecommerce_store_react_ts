    ...
    return <NavbarBs sticky='top' className='bg-white shadow-sm mb-3'>
        <Container>
            ...
            {cartQuantity > 0 && <Button onClick={openCart} style={{ width: '3rem', height: '3rem', position: 'relative' }} variant="outline-primary" className="rounded-circle">
                ...
                <div
                    style={{
                        color: 'white', height: '1.5rem', width: '1.5rem', position: 'absolute',
                        bottom: '0', right: '0',
                        transform: 'translate(25%,25%)'
                    }}
                    className="bg-danger rounded-circle d-flex justify-content-center align-items-center">{cartQuantity}</div>
            </Button>}
        </Container>
    </NavbarBs>
}